...
async function main() {
    try {
        ...
        const testUserDataDir = path.join(tmpDir, 'vscode-test-data-' + Date.now());
        ...
        await (0, test_electron_1.runTests)({
            ...
            launchArgs: [
                ...
                '--user-data-dir=' + testUserDataDir, // Use a temporary user data directory
                ...
                '--disable-gpu' // Disable GPU for testing
            ]
        });
    }
    catch (err) {
